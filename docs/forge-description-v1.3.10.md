...
Public beta for SPT 4.1.5, published September 5, 2026. Call in A-10 strafes,
UH-60 extraction and cargo transfer, or UAV reconnaissance through the
TerraGroup TSC Uplink.
...
This release updates TSC's declared SPT target and retains the gameplay
...
actions. See the [release notes](release-notes-v1.3.10.md) and
...
update SPT to 4.1.5, and extract the full v1.3.10 ZIP into the SPT
