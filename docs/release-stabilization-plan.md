...
- The aligned simplified storefront replaced only the live Core/client DLL. Its installed SHA-256 is `B236125E873EDC7D6069AA8DAD132F76B9EB43919CC1C74751EC30B2A353916C`; Fika, Fika Interop, and Server remain byte-identical to the Phase 1A install. The pre-alignment Core and rollback instructions are backed up at `C:\Users\tylev\Desktop\RaidOps\backups\TSC-live-pre-header-align-8948b10-20260724-125503`.
