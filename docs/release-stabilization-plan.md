...
- The simplified storefront replaced only the live Core/client DLL. Its installed SHA-256 is `668170459D70E1C334E0B570B37CA6B30A705A782C75D0FDF916662D390002D7`; Fika, Fika Interop, and Server remain byte-identical to the Phase 1A install. The immediately prior dashboard-shell Core and rollback instructions are backed up at `C:\Users\tylev\Desktop\RaidOps\backups\TSC-live-pre-simple-style-3f83aaa-20260724-124858`.
