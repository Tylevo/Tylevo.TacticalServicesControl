...
Close the game and server, back up profiles and settings, then install the full main ZIP. Keep all Fika players on the same TSC version. Dependencies: **UnityToolkit 2.0.2** and **WTT CommonLib 3.0.6**, installed separately.

The latest phone visuals and current Fika multiplayer still need in-game testing.
